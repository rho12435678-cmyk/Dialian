...
REPLY = (
    f"<@&{CUSTOMER_ROLE_ID}>\n\n"
    "📢 **DDS UI 커미션 분야 도입 관련 안내**\n\n"
    "이번 투표는 UI 커미션 도입에 대한 여러분의 수요를 확인하기 위한 사전 설문입니다.\n\n"
    "**찬성 의견이 많더라도 UI 분야가 즉시 추가되는 것은 아닙니다.** "
    "외주 디자이너분들과 제작 가능 여부, 작업 범위, 예상 수요, 가격 및 "
    "운영 일정 등 필요한 사항을 충분히 논의하겠습니다.\n\n"
    "논의 후 최종 승인이 이루어지면 도입을 추진할 계획입니다. "
